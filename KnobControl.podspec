...
Pod::Spec.new do |s|
  ...
  s.author             = { "majunliang" => "amjunliang@163.com" }
  # Or just: s.author    = "majunliang"
  # s.authors            = { "majunliang" => "amjunliang@163.com" }
  # s.social_media_url   = "http://twitter.com/majunliang"
  ...
  s.source       = { :git => "https://github.com/amjunliang/KnobControl.git", :tag => "1.0.0" }
